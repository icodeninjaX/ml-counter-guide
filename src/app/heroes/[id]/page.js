...
export default function HeroDetail({ params }) {
  ...
  if (!hero) {
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="text-center p-8 bg-gray-800 bg-opacity-70 rounded-xl border border-gray-700 max-w-md">
          <svg className="w-20 h-20 mx-auto text-gray-500 mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
  ...
  return (
    <div className="py-6">
      {/* Hero Header */}
      <div className="bg-gray-800 bg-opacity-70 rounded-xl shadow-xl p-8 mb-8 border border-gray-700">
        <div className="flex flex-col md:flex-row md:justify-between md:items-center mb-6">
          <div>
            <h1 className="text-4xl font-bold mb-2 text-blue-400">{hero.name}</h1>
      ...
      {/* Tab Content */}
      <div className="bg-gray-800 bg-opacity-70 rounded-xl shadow-xl p-8 mb-8 border border-gray-700 min-h-[400px]">
        {/* Overview Tab */}
        {activeTab === 'overview' && (
          <div>
            ...
            {/* Synergies */}
            <div className="bg-gray-700 bg-opacity-50 p-6 rounded-lg shadow-md mb-6">
        ...
        {activeTab === 'skills' && (
          <div>
            <h2 className="text-2xl font-bold mb-6 text-yellow-400">Hero Skills</h2>
            
            <div className="space-y-6">
              {hero.skills.map((skill, index) => (
                <div key={index} className="bg-gray-700 bg-opacity-50 p-5 rounded-lg shadow-md">
                  <div className="flex flex-wrap items-center mb-2">
                    <h3 className="font-bold text-xl text-yellow-300 mr-3">{skill.name}</h3>
                    <span className="px-2 py-1 bg-gray-800 rounded-md text-xs text-gray-300">{skill.type}</span>
                  </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div>
                ...
                {hero.counters && hero.counters.length > 0 ? (
                  ...
                  <div className="bg-gray-700 bg-opacity-50 p-4 rounded-lg text-gray-400">
        ...
        {activeTab === 'tips' && (
          <div>
            {/* Tips Section */}
            <div className="mb-8">
              <h2 className="text-2xl font-bold mb-6 text-blue-400">Playing Tips</h2>
              
              <ul className="space-y-3">
                {hero.tips.map((tip, index) => (
                  <li key={index} className="bg-gray-700 bg-opacity-50 p-4 rounded-lg flex items-start">
            ...
            {/* Build Section */}
            <div>
              <h2 className="text-2xl font-bold mb-6 text-blue-400">Recommended Builds</h2>
              
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                {/* Recommended Items */}
                <div className="bg-gray-700 bg-opacity-50 p-5 rounded-lg shadow-md">
                  <h3 className="font-bold text-lg text-yellow-300 mb-4">Core Items</h3>
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                    {hero.build.recommended.map((item, index) => (
                      <div key={index} className="bg-gray-800 p-3 rounded-lg text-center">
                        <div className="w-12 h-12 bg-gray-600 rounded-full mx-auto mb-2 flex items-center justify-center text-2xl">
                          {index + 1}
                        </div>
                ...
                {/* Situational Items */}
                <div className="bg-gray-700 bg-opacity-50 p-5 rounded-lg shadow-md">
                  <h3 className="font-bold text-lg text-yellow-300 mb-4">Situational Items</h3>
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-3">

  ...
  return (
    <main className="flex min-h-screen flex-col items-center p-4 pt-8">
      ...
      <motion.section
        ...
        className="max-w-4xl w-full glass rounded-xl shadow-xl p-8 mb-10 border border-gray-700"
      >
      ...
      <motion.section
        ...
        className="max-w-4xl w-full glass rounded-xl shadow-xl p-8 border border-gray-700"
      >
